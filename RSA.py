...
# n = p * q
# phi(n) = (p - 1) * (q - 1)
# find any e such that it satisfies {1 < e < phi(n)} & {gcd(e, phi(n)) === 1}
# find value of { de mod phi(n) === 1 } find first value of d that satisfies the equation
# Public Key = {e, n}
# Private Key = {d, n}
# Encyption: C = (M ^ e) mod n
